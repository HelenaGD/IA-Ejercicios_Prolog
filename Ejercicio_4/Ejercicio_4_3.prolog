...
% Con acumulador
hanoi_acc(N,L) :- mover_acc(N, 1, 2, 3, L, Acc). % El Acc comienza con una lista vacía 

mover_acc(0, _, _, _, L, L). % El camino final será el acumulado
mover_acc(N, P1, P2, P3, L1, Acc) :- 
  N > 0,
  M is N-1,
  append(L1, [mover(P1, P3)], L2), % Se guarda en L2
  mover_acc(M, P1, P3, P2, L2, Acc), % Se hace el movimiento
  mover_acc(M, P3, P2, P1, L2, Acc).